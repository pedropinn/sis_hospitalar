...
public class Cadastro {
    ...
    public void cadastroMedico() {
        ...
        System.out.println("Digite o indentificação local:");
        m1.setIden(Integer.parseInt(sc.nextLine()));
        System.out.println("Digite o CRM:");
        m1.setCrm(Integer.parseInt(sc.nextLine()));
        m1.setCargo("Médico");
    }
    ...
    public void cadastroFunc() {
        ...
        System.out.println("Digite o indentificação local:");
        f1.setIden(Integer.parseInt(sc.nextLine()));
    ...
    public void cadastroRemedio() {
        System.out.println("Digite o nome do remédico:");
        r1.setNome(sc.nextLine());
        System.out.println("Digite o codigo de barras:");
        r1.setCodigo(Integer.parseInt(sc.nextLine()));
        System.out.println("Digite a descrição:");
        r1.setDescricao(sc.nextLine());
    }
    ...
    public void imprimirConsulta() {
        ...
        m1.imprimeDados();
        System.out.println("");
        System.out.println("Ministrar medicação:");
        r1.imprimeDados();
        System.out.print("\n");
    }
